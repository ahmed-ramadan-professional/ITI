...
import { Mail, User, AtSign, MapPin, Briefcase, Edit3 } from 'lucide-react';

export default function Profile() {
    const profile = {
        name: 'Ahmed Ramadan',
        username: '@ahmed-ramadan-professional',
            ...
            <div
                ...
                <div
                    ...
                    <div
                        className="
                            h-44
                            bg-gradient-to-r from-cyan-500/20 via-slate-900 to-cyan-400/10
                            border-b border-white/10
                            relative
                        ">
                        <div
                            className="
                                bg-[radial-gradient(circle_at_top_right,rgba(34,211,238,0.18),transparent_30%)]
                                absolute inset-0
                            "
                        />
                    </div>
                            ...
                            {profile.stats.map((stat) => (
                                <div
                                    ...
                                    className="
                                        ...
                                        rounded-2xl border border-white/10
                                        shadow-lg shadow-black/20 transition-all
                                        backdrop-blur-md duration-300 hover:-translate-y-1 hover:scale-[1.01] hover:border-cyan-400/40 hover:shadow-cyan-500/10
                                    ">
                                    <p
                                        className="
                        ...
                        <div
                            ...
                            <div
                                ...
                                <p
                                    ...
                                    states. I enjoy turning clean layouts into
                                    experiences that feel premium and easy to
                                    use.
                                </p>
                            </div>
                        </div>
    ...
    return (
        <div
            className="
                ...
                transition-all
                items-center gap-4 duration-300 hover:border-cyan-400/30 hover:bg-white/[0.05]
            ">
            <div
                className="
                    flex
